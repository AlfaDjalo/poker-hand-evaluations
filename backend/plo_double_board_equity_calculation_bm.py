...
def main():
    ...
    # print(equities)
    # equities = calculate_equity_for_multiple_hands_exhaustive(db, [["As", "Jd", "7s", "5c"], ["Qh", "Jc", "9c", "8h"]], ["Tc", "7d", "7c"], debug=True)
    # print(equities)
    # equities = calculate_equity_for_multiple_hands_exhaustive(db, [["As", "Jd", "7s", "5c"], ["Qh", "Jc", "9c", "8h"]], ["Tc", "7d", "7c", "2h"], debug=True)
    # print(equities)
    # equities = calculate_equity_for_multiple_hands_exhaustive(db, [["As", "Jd", "7s", "5c"], ["Qh", "Jc", "9c", "8h"]], ["Tc", "7d", "7c", "2h", "4d"], debug=True)
    # print(equities)
